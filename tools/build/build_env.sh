...
PVA_PY_VERSION=0.9.1
PVA_PY_PYTHON3_VERSION=0.9.1
...
PVA_PY_DIR=$EPICS_MODULES_DIR/pvaPy-$PVA_PY_VERSION
PVA_PY_PYTHON3_DIR=$EPICS_MODULES_DIR/pvaPy-python3-$PVA_PY_PYTHON3_VERSION
