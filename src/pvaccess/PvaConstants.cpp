...
const std::string PvaConstants::DefaultKey(PVA_DEFAULT_KEY);

const std::string PvaConstants::StructureId(PVA_STRUCTURE_ID);
...
const std::string PvaConstants::ValueFieldKey(PVA_VALUE_FIELD_KEY);
