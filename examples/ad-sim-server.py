...
class AdSimServer:
    ...
    def __init__(self, input_file, frame_rate, nf, nx, ny, runtime, channel_name, start_delay):
        self.arraySize = None
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Area detector simulator')
    ...
    daq = AdSimServer(input_file=args.input_file, frame_rate=args.frame_rate, nf=args.n_frames, nx=args.n_x_pixels, ny=args.n_y_pixels, runtime=args.runtime, channel_name=args.channel_name, start_delay=args.start_delay)
