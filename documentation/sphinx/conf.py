...
## and modified for Computational Crystallography Toolbox
## See: 
##     http://bazaar.launchpad.net/~eudoxos/minieigen/trunk/view/head:/doc/source/conf.py
##     http://sourceforge.net/p/cctbx/code/HEAD/tree/trunk/dox.sphinx/conf.py
##
...
# -*- coding: utf-8 -*-
#
# EPICS4 pvaPy documentation build configuration file, created by
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.autosummary', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig']
...
project = u'EPICS4 pvaPy'
copyright = u'2014, EPICS4'
...
htmlhelp_basename = 'EPICS4pvaPydoc'
...
latex_documents = [
  ('index', 'EPICS4pvaPy.tex', u'EPICS4 pvaPy Documentation',
   u'EPICS4', 'manual'),
]
