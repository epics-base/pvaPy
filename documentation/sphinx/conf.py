...
# -*- coding: utf-8 -*-
#
# EPICS PvaPy documentation build configuration file, created by
...
htmlhelp_basename = 'EPICSPvaPydoc'
...
latex_documents = [
  ('index', 'EPICSPvaPy.tex', u'EPICS PvaPy Documentation',
   u'EPICS', 'manual'),
]
