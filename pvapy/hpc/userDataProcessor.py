...
class UserDataProcessor:
    ...
    **UserDataProcessor(configDict={})**
    ...
    def getOutputPvaTypes(self):
        ...
        this method if the structure of input and output objects are the same, or
        if the application will not publish processing output.
        
        :Returns: Dictionary containing PVA types for the object generated by the process() method
        '''
        return {}
