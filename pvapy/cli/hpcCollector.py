...
class CollectorController:
    ...
    def stopCollectors(self):
        ...
        try: 
            ...
            self.logger.info(f'Stopped collector {self.dataCollector.collectorId}')
        except Exception as ex:
