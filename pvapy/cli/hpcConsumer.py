...
class ConsumerController:
    ...
    def createConsumer(self, consumerId, args):
        ...
        self.usingPvObjectQueue = (args.consumer_queue_size >= 0)
        self.pvaServer = None
        ...
        self.dataConsumer = DataConsumer(consumerId, inputChannel, providerType=args.input_provider_type, serverQueueSize=args.server_queue_size, consumerQueueSize = args.consumer_queue_size, distributorPluginName=args.distributor_plugin_name, distributorGroupId=args.distributor_group, distributorSetId=args.distributor_set, distributorTriggerFieldName=args.distributor_trigger, distributorUpdates=args.distributor_updates, distributorUpdateMode=None, processingController=processingController)
